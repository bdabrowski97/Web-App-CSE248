...
<body>
	...
	<button onclick=window.location="http://localhost:8080/adminCancelOrder2">CANCEL ORDER</button>
	<br><br><br>
	<button onclick=window.location="http://localhost:8080/inspectAccountPurchases">Go Back</button>
