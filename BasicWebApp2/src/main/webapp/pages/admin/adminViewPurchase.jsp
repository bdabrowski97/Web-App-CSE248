...
<body>
	...
	<button onclick=window.location="http://localhost:8080/adminCancelOrder">CANCEL ORDER</button>
	<br><br><br>
	<button onclick=window.location="http://localhost:8080/viewAllPurchases">Go Back</button>
